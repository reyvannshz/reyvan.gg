...
-- Cari target dalam FOV — FOV diukur dari posisi mouse (GetMouseLocation = viewport coords)
    ...
    for _, plr in pairs(Players:GetPlayers()) do
        if plr ~= LocalPlayer then
            ...
            if char then
                ...
                local part = char:FindFirstChild(aimbotTarget)  -- Head atau HumanoidRootPart
...
print("- 🚀 Teleport")
print("- 🎯 AIMBOT: FOV center crosshair | FreeAim fix | MB4/MB5")
print("========================================")
