...
do
    ...
    -- Info cara kerja
    local infoCard = makeCard(pageSell, 142, 44)
    makeLabel(infoCard, "🤝 Interact otomatis (tekan E) untuk menjual", 10, 4, 280, 16, 11, C.subtext, Enum.Font.Gotham)
    makeLabel(infoCard, "🔄 Loop sampai inventory kosong", 10, 24, 280, 16, 11, C.subtext, Enum.Font.Gotham)
