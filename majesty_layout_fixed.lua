...
do
    ...
    sectionTitle(pageAuto,"AUTO SELL",520)

    local sellTogBtn = Instance.new("TextButton")
    sellTogBtn.Size = UDim2.new(1,-20,0,36)
    sellTogBtn.Position = UDim2.new(0,10,0,546)
    ...
    local ssc = makeCard(pageAuto,590,44); makeLabel(ssc,"SELL",12,0,80,44,10,C.subtext)
    sellStatusLbl_ref = makeLabel(ssc,"OFF",90,0,200,44,13,C.red)
    local sic = makeCard(pageAuto,642,44); makeLabel(sic,"ITEM",12,0,80,44,10,C.subtext)
    sellItemLbl_ref = makeLabel(sic,"-",90,0,280,44,13,C.text)
    local sfc = makeCard(pageAuto,694,44); makeLabel(sfc,"FASE",12,0,80,44,10,C.subtext)
    local asPhaseLbl = makeLabel(sfc,"Idle",90,0,280,44,12,C.accent2)
    local stc = makeCard(pageAuto,746,40); makeLabel(stc,"TERJUAL",12,0,80,40,10,C.subtext)
    ...
    -- ========== BUY (from arul) ==========
    sectionTitle(pageAuto,"BUY BAHAN",830)
    ...
    makeSliderRow(912,"Sugar Block Bag",
    ...
    local buyTogBtn=Instance.new("TextButton"); buyTogBtn.Size=UDim2.new(1,-20,0,36); buyTogBtn.Position=UDim2.new(0,10,0,1028)
    ...
    local bsc=makeCard(pageAuto,1072,44); makeLabel(bsc,"STATUS",12,0,80,44,10,C.subtext)
    local bsl=makeLabel(bsc,"OFF",90,0,180,44,13,C.red)
    local bpc=makeCard(pageAuto,1124,44); makeLabel(bpc,"PHASE",12,0,80,44,10,C.subtext)
    local bpl=makeLabel(bpc,"Idle",90,0,280,44,13,C.accent2)
    local bicc=makeCard(pageAuto,1176,44); makeLabel(bicc,"ITEM",12,0,80,44,10,C.subtext)
