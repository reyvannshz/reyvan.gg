...
-- ========== TELEPORT FINAL - REPEAT LOOP METHOD ==========
-- Cara paling simple dan paling reliable:
-- Set CFrame + repeat selama 60 frame sambil zero velocity
-- Tidak pakai respawn, tidak pakai anchor, tidak pakai LoadCharacter
...
local function doTeleport(targetCFrame)
    task.spawn(function()
        ...
        -- Coba aktifkan network ownership agar client bisa set posisi
        pcall(function()
            hrp:SetNetworkOwner(LocalPlayer)
        end)

        -- Repeat set posisi selama 60 frame (~1 detik di 60fps)
        -- Ini override server reset yang terjadi tiap ~100ms
        for i = 1, 60 do
