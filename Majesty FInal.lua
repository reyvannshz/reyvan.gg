...
do
    ...
    -- ========== AUTO BUY ==========
    -- ========== AUTO BUY ==========
    sectionTitle(pageAuto,"AUTO BUY BAHAN",700)
    local buyQty_water=1; local buyQty_sugar=1; local buyQty_gelatin=1
    local autoBuyFull=false
    local buyFullStatusRef, buyFullPhaseRef, buyFullItemRef

    local bsc=makeCard(pageAuto,726,44); makeLabel(bsc,"STATUS",12,0,80,44,10,C.subtext)
    buyFullStatusRef=makeLabel(bsc,"OFF",90,0,200,44,13,C.red)
    local bpc=makeCard(pageAuto,778,44); makeLabel(bpc,"PHASE",12,0,80,44,10,C.subtext)
    buyFullPhaseRef=makeLabel(bpc,"Idle",90,0,280,44,13,C.accent2)
    local bic2=makeCard(pageAuto,830,44); makeLabel(bic2,"ITEM",12,0,80,44,10,C.subtext)
    buyFullItemRef=makeLabel(bic2,"-",90,0,280,44,13,C.text)

    local function makeQtyRow2(yPos,label,getV,setV)
        local card=makeCard(pageAuto,yPos,44)
        makeLabel(card,label,10,0,160,44,12,C.text)
        local mBtn=Instance.new("TextButton"); mBtn.Size=UDim2.new(0,28,0,26); mBtn.Position=UDim2.new(0,170,0,9)
        mBtn.Text="-"; mBtn.TextSize=16; mBtn.Font=Enum.Font.Gotham; mBtn.BackgroundColor3=Color3.fromRGB(50,15,15); mBtn.TextColor3=C.red; mBtn.BorderSizePixel=0; mBtn.Parent=card; mkCorner(mBtn,5)
        local qLbl=Instance.new("TextLabel"); qLbl.Size=UDim2.new(0,38,0,26); qLbl.Position=UDim2.new(0,203,0,9)
        qLbl.Text="1"; qLbl.TextSize=13; qLbl.Font=Enum.Font.Gotham; qLbl.BackgroundTransparency=1; qLbl.TextColor3=C.text; qLbl.TextXAlignment=Enum.TextXAlignment.Center; qLbl.Parent=card
        local pBtn=Instance.new("TextButton"); pBtn.Size=UDim2.new(0,28,0,26); pBtn.Position=UDim2.new(0,246,0,9)
        pBtn.Text="+"; pBtn.TextSize=16; pBtn.Font=Enum.Font.Gotham; pBtn.BackgroundColor3=Color3.fromRGB(0,40,20); pBtn.TextColor3=C.accent; pBtn.BorderSizePixel=0; pBtn.Parent=card; mkCorner(pBtn,5)
        mBtn.MouseButton1Click:Connect(function() setV(math.max(0,getV()-1)); qLbl.Text=tostring(getV()) end)
        pBtn.MouseButton1Click:Connect(function() setV(math.min(99,getV()+1)); qLbl.Text=tostring(getV()) end)
    end
    makeQtyRow2(882,"💧 Water",
        function() return buyQty_water end,
        function(v) buyQty_water=v end)
    makeQtyRow2(932,"🧂 Sugar Block Bag",
        function() return buyQty_sugar end,
        function(v) buyQty_sugar=v end)
    makeQtyRow2(982,"🟡 Gelatin",
        function() return buyQty_gelatin end,
        function(v) buyQty_gelatin=v end)

    local buyTogBtn=Instance.new("TextButton"); buyTogBtn.Size=UDim2.new(1,-20,0,36); buyTogBtn.Position=UDim2.new(0,10,0,1034)
    buyTogBtn.BackgroundColor3=C.card; buyTogBtn.Text="🚀 AUTO BUY : OFF"; buyTogBtn.TextColor3=C.red
    ...
    buyTogBtn.MouseButton1Click:Connect(function()
        autoBuyFull = not autoBuyFull
        if autoBuyFull then
            buyTogBtn.Text="🚀 AUTO BUY : ON"; buyTogBtn.TextColor3=C.accent
            buyFullStatusRef.Text="STARTING"; buyFullStatusRef.TextColor3=C.yellow
        else
            buyTogBtn.Text="🚀 AUTO BUY : OFF"; buyTogBtn.TextColor3=C.red
            buyFullStatusRef.Text="OFF"; buyFullStatusRef.TextColor3=C.red
            buyFullPhaseRef.Text="Idle"; buyFullItemRef.Text="-"
        end
    end)

    pageAuto.CanvasSize=UDim2.new(0,0,0,1090)
end
...
-- ========== PAGE: TELEPORT ==========
do
    sectionTitle(pageTP,"TELEPORT LOKASI",8)
    local infoCard=makeCard(pageTP,34,28)
    ...
    local tpLocs={
        {label="🚗  Dealership",           color=Color3.fromRGB(0,110,220),  x=732.1171264648438,   y=3.3621320724487305,   z=406.0807189941406},
        {label="🍡  Jual/Beli Marshmellow", color=Color3.fromRGB(180,80,0),   x=510.9961853027344,   y=3.5872106552124023,   z=598.3929443359375},
        {label="⭐  Tier",                  color=Color3.fromRGB(120,0,200),  x=1094.7406005859375,  y=3.188796043395996,    z=158.09230041503906},
        {label="🎰  Casino",               color=Color3.fromRGB(180,120,0),  x=1154.863525390625,   y=4.289375305175781,    z=-46.8486328125},
        {label="💰  Jual Casino",           color=Color3.fromRGB(160,100,0),  x=1017.5814819335938,  y=4.545021533966064,    z=-321.7923889160156},
        {label="🛣️  GS Ujung",             color=Color3.fromRGB(80,80,80),   x=-464.5489501953125,  y=3.7371325492858887,   z=335.3158874511719},
        {label="🛣️  GS Mid",               color=Color3.fromRGB(80,80,80),   x=218.74879455566406,  y=3.729842185974121,    z=-161.87036132812},
    }
    for i,loc in ipairs(tpLocs) do
        local yp=70+(i-1)*44
        local btn=Instance.new("TextButton"); btn.Size=UDim2.new(1,-20,0,36); btn.Position=UDim2.new(0,10,0,yp)
        btn.BackgroundColor3=C.card; btn.Text=loc.label; btn.TextColor3=C.text
        btn.Font=Enum.Font.Gotham; btn.TextSize=12; btn.TextXAlignment=Enum.TextXAlignment.Left
        btn.BorderSizePixel=0; btn.Parent=pageTP; mkCorner(btn,5); mkStroke(btn,1,loc.color)
    ...
    pageTP.CanvasSize=UDim2.new(0,0,0,80+#tpLocs*44)
end

-- ========== PAGE: KENDARAAN TP ==========
do
    sectionTitle(pageVehicleTP,"TELEPORT KENDARAAN",8)
    local infoCard2=makeCard(pageVehicleTP,34,28)
    makeLabel(infoCard2,"✅ Tidak perlu mati  |  Bisa dipakai saat naik motor",10,0,440,28,10,Color3.fromRGB(0,220,100))
    ...
    LocalPlayer.CharacterAdded:Connect(function(char) task.spawn(hookChar,char) end)

    local vehStatusCard=makeCard(pageVehicleTP,70,30)
    local vehStatusLbl=makeLabel(vehStatusCard,"Kendaraan  ›  Tidak ditemukan",10,0,400,30,11,C.red)
    task.spawn(function()
        while true do
            task.wait(1)
            if cachedSeat then
                local m=cachedSeat:FindFirstAncestorWhichIsA("Model")
                vehStatusLbl.Text="Kendaraan  ›  "..(m and m.Name or cachedSeat.Name)
    ...
    sectionTitle(pageVehicleTP,"TELEPORT LOKASI",108)
    ...
    sectionTitle(pageVehicleTP,"KOMPOR APARTMENT",134+#vtpLocs*44+8)
    local kompors={
        {label="🍳 Kompor Apart 1", x=897.308837890625,   y=10.105066299438477, z=39.217220306396484},
        {label="🍳 Kompor Apart 2", x=925.7492065429688,  y=10.105064392089844, z=39.23077392578125},
        {label="🍳 Kompor Apart 3", x=984.796875,         y=10.105064392089844, z=248.2229461669922},
        {label="🍳 Kompor Apart 4", x=984.8067626953125,  y=10.105064392089844, z=219.7691192626953},
        {label="🍳 Kompor Apart 5", x=1141.9276123046875, y=10.105062484741211, z=451.07061767578125},
        {label="🍳 Kompor Apart 6", x=1141.8072509765625, y=10.105064392089844, z=422.4674987792969},
    }
    local kompBase=134+#vtpLocs*44+34
    for i,k in ipairs(kompors) do
        local yp=kompBase+(i-1)*44
        local btn=Instance.new("TextButton"); btn.Size=UDim2.new(1,-20,0,36); btn.Position=UDim2.new(0,10,0,yp)
        btn.BackgroundColor3=C.card; btn.Text=k.label; btn.TextColor3=C.text
        btn.Font=Enum.Font.Gotham; btn.TextSize=12; btn.TextXAlignment=Enum.TextXAlignment.Left
    ...
    pageVehicleTP.CanvasSize=UDim2.new(0,0,0,kompBase+#kompors*44)
end
...
local cachedSeatBuy = nil

local function tpVehicleTo(x, y, z)
    local char = LocalPlayer.Character; if not char then return end
    local hrp = char:FindFirstChild("HumanoidRootPart"); if not hrp then return end
    local targetCF = CFrame.new(x, y + 2, z)
    if cachedSeatBuy then
        local vehModel = cachedSeatBuy:FindFirstAncestorWhichIsA("Model")
        if vehModel and vehModel.PrimaryPart then
            local seatOffset = vehModel.PrimaryPart.CFrame:Inverse() * cachedSeatBuy.CFrame
            vehModel:SetPrimaryPartCFrame(targetCF * seatOffset:Inverse())
        elseif vehModel then
            local delta = targetCF * cachedSeatBuy.CFrame:Inverse()
            for _, part in ipairs(vehModel:GetDescendants()) do
                if part:IsA("BasePart") then part.CFrame = delta * part.CFrame end
            end
        end
...
task.spawn(function()
    while true do
        ...
        if not cachedSeatBuy then
            local hum2 = char:FindFirstChildOfClass("Humanoid")
            if hum2 and hum2.SeatPart then
                local s = hum2.SeatPart
                if s:IsA("Seat") or s:IsA("VehicleSeat") then cachedSeatBuy = s end
            end
        end

        autoBuyFull = false
        buyFullStatusRef.Text = "RUNNING..."
        buyFullStatusRef.TextColor3 = Color3.fromRGB(255, 180, 0)

        buyFullPhaseRef.Text = "TP ke NPC..."
        tpVehicleTo(LAMONT_X, LAMONT_Y, LAMONT_Z)
        task.wait(2)

        buyFullPhaseRef.Text = "Cari NPC..."
        local prompt = nil
        ...
        if not prompt then
            buyFullPhaseRef.Text = "NPC tidak ketemu!"
            buyFullPhaseRef.TextColor3 = Color3.fromRGB(255, 80, 80)
            task.wait(2); continue
        end

        buyFullPhaseRef.Text = "Interact NPC..."
        ...
        while t < 8 and not shopOpened do
            ...
            if not shopOpened then
                ...
                if fc and fc.Visible and fc.Text ~= "" and not fc.Text:lower():find("nevermind") then
                    buyFullPhaseRef.Text = "Klik dialog..."
        ...
        if not shopOpened then
            buyFullPhaseRef.Text = "Gagal, ulangi..."
            buyFullPhaseRef.TextColor3 = Color3.fromRGB(255, 80, 80)
            task.wait(1); continue
        end

        buyFullPhaseRef.Text = "Beli item..."
        ...
        if scrollFrame then
            local buyList = {
                {name="Water",           amount=buyQty_water,  color=Color3.fromRGB(0,180,255)},
                {name="Sugar Block Bag", amount=buyQty_sugar,  color=Color3.fromRGB(255,180,50)},
                {name="Gelatin",         amount=buyQty_gelatin,color=Color3.fromRGB(255,220,50)},
            }
            for _, entry in ipairs(buyList) do
                ...
                if itemBtn then
                    for i = 1, entry.amount do
                        buyFullPhaseRef.Text = "Beli item"
                        buyFullItemRef.Text  = entry.name.." ("..i.."/"..entry.amount..")"
        ...
        task.wait(0.5)
        buyFullStatusRef.Text = "SELESAI ✅"; buyFullStatusRef.TextColor3 = Color3.fromRGB(0,200,255)
        buyFullPhaseRef.Text = "Done"; buyFullItemRef.Text = "Done ✅"
        task.wait(2)
        buyFullStatusRef.Text = "OFF"; buyFullStatusRef.TextColor3 = C.red
        buyFullPhaseRef.Text = "Idle"; buyFullItemRef.Text = "-"
    end
