...
local function doTeleport(targetCFrame)
    ...
    -- Paksa Physics state agar server tidak koreksi posisi
    ...
    -- Pindah posisi tanpa kill
    hrp.CFrame = targetCFrame
    task.wait(0.2)

    -- Set ulang sekali lagi supaya tidak di-reset server
    hrp.AssemblyLinearVelocity  = Vector3.zero
    hrp.AssemblyAngularVelocity = Vector3.zero
    hrp.CFrame = targetCFrame
    task.wait(0.3)
