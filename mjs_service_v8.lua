...
-- Jual satu item: equip → tekan E berulang tiap 0.5 detik sampai terkonfirmasi terjual.
-- "Berulang" diperlukan karena NPC mungkin butuh beberapa frame untuk proses interact.
...
local function trySellOne(msName, setStatus2)
    ...
    setStatus2("Jual: "..msName.." — tekan E...", Color3.fromRGB(50,210,110))

    -- ── Loop tekan E setiap 0.5 detik sampai item terjual ──
    -- Ini memastikan interaksi NPC selesai meskipun butuh beberapa kali press.
    local elapsed  = 0
    local sold     = false
    local pressInt = 0.5   -- interval tekan E (detik)
    local pressAcc = 0     -- akumulator sejak press terakhir
