...
do
    ...
    local fullyCoordLbl  = makeLabel(fullyCoordCard,"Belum disimpan",10,0,270,34,10,C.subtext)
    local savePosBtn = Instance.new("TextButton")
    savePosBtn.Size=UDim2.new(0,80,0,26); savePosBtn.Position=UDim2.new(1,-90,0.5,-13)
    savePosBtn.BackgroundColor3=C.purple; savePosBtn.Text="📍 Save"
    savePosBtn.TextColor3=Color3.fromRGB(255,255,255); savePosBtn.Font=Enum.Font.GothamBold
    savePosBtn.TextSize=10; savePosBtn.BorderSizePixel=0; savePosBtn.Parent=fullyCoordCard; mkCorner(savePosBtn,5)
    ...
    fullyTargetLbl.Size=UDim2.new(0,44,1,0); fullyTargetLbl.Position=UDim2.new(0.5,-22,0,0)
    ...
    local ftMinB=Instance.new("TextButton"); ftMinB.Size=UDim2.new(1,0,1,0); ftMinB.Text="-"; ftMinB.TextSize=16; ftMinB.Font=Enum.Font.GothamBold; ftMinB.BackgroundTransparency=1; ftMinB.TextColor3=C.red; ftMinB.BorderSizePixel=0; ftMinB.Parent=ftMinW; mkCorner(ftMinW,5)
    ...
    local ftPlusB=Instance.new("TextButton"); ftPlusB.Size=UDim2.new(1,0,1,0); ftPlusB.Text="+"; ftPlusB.TextSize=16; ftPlusB.Font=Enum.Font.GothamBold; ftPlusB.BackgroundTransparency=1; ftPlusB.TextColor3=C.accent; ftPlusB.BorderSizePixel=0; ftPlusB.Parent=ftPlusW; mkCorner(ftPlusW,5)
    ftMinB.MouseButton1Click:Connect(function()
        fullyTarget = math.max(1, fullyTarget-1); fullyTargetLbl.Text = tostring(fullyTarget)
    end)
    ftPlusB.MouseButton1Click:Connect(function()
        fullyTarget = math.min(99, fullyTarget+1); fullyTargetLbl.Text = tostring(fullyTarget)
    end)
    ...
    fullyStartBtn.Size=UDim2.new(0.48,-12,0,34); fullyStartBtn.Position=UDim2.new(0,10,0,fullyBase+210)
    fullyStartBtn.BackgroundColor3=C.card; fullyStartBtn.Text="START FULLY"
    fullyStartBtn.TextColor3=C.accent; fullyStartBtn.Font=Enum.Font.GothamBold
    fullyStartBtn.TextSize=11; fullyStartBtn.BorderSizePixel=0; fullyStartBtn.Parent=pageVehicleTP
    mkCorner(fullyStartBtn,5); mkStroke(fullyStartBtn,1,C.accent)

    local fullyStopBtn = Instance.new("TextButton")
    fullyStopBtn.Size=UDim2.new(0.48,-12,0,34); fullyStopBtn.Position=UDim2.new(0.5,2,0,fullyBase+210)
    fullyStopBtn.BackgroundColor3=C.card; fullyStopBtn.Text="STOP FULLY"
    fullyStopBtn.TextColor3=C.red; fullyStopBtn.Font=Enum.Font.GothamBold
    fullyStopBtn.TextSize=11; fullyStopBtn.BorderSizePixel=0; fullyStopBtn.Parent=pageVehicleTP
    ...
    pageVehicleTP.CanvasSize=UDim2.new(0,0,0,fullyBase+260)
end
...
local function triggerSafeEscape(newHP)
    ...
    task.spawn(function()
        task.wait(0.5)
        if safeModeStatusLbl then safeModeStatusLbl.Text = "SELAMAT"; safeModeStatusLbl.TextColor3 = C.accent end
        task.wait(1.5)
