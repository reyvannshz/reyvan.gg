...
-- ========== FUNGSI TELEPORT V5 - MULTI METHOD ==========
-- Coba beberapa metode secara berurutan sampai berhasil
...
local function doTeleport(targetCFrame)
    ...
    -- ===== METODE 2: CFrame langsung + velocity zero loop =====
    ...
    -- ===== METODE 3: WalkTo lalu snap (fallback jarak dekat) =====
    pcall(function()
        humanoid:ChangeState(Enum.HumanoidStateType.Physics)
