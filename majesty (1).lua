...
espSeparator.Size = UDim2.new(1, -20, 0, 2)
espSeparator.Position = UDim2.new(0, 10, 0, 545)
espSeparator.BackgroundColor3 = Color3.fromRGB(180, 0, 255)
espSeparator.BorderSizePixel = 0
espSeparator.Parent = content

local espTitle = Instance.new("TextLabel")
espTitle.Size = UDim2.new(1, -10, 0, 30)
espTitle.Position = UDim2.new(0, 5, 0, 555)
espTitle.BackgroundTransparency = 1
espTitle.Text = "👁️ ESP PLAYER"
...
-- ESP Toggle Button
local espBtnFrame = Instance.new("Frame")
espBtnFrame.Size = UDim2.new(1, -10, 0, 50)
espBtnFrame.Position = UDim2.new(0, 5, 0, 590)
espBtnFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 35)
espBtnFrame.Parent = content

local espBtnCorner = Instance.new("UICorner")
espBtnCorner.CornerRadius = UDim.new(0, 8)
espBtnCorner.Parent = espBtnFrame

local espToggleBtn = Instance.new("TextButton")
espToggleBtn.Size = UDim2.new(1, -20, 0, 35)
espToggleBtn.Position = UDim2.new(0, 10, 0, 7)
espToggleBtn.BackgroundColor3 = Color3.fromRGB(60, 0, 120)
...
espToggleBtn.Parent = espBtnFrame
...
-- ESP Color Info
local espColorInfo = Instance.new("TextLabel")
espColorInfo.Size = UDim2.new(1, -20, 0, 20)
espColorInfo.Position = UDim2.new(0, 10, 0, 648)
espColorInfo.BackgroundTransparency = 1
espColorInfo.Text = "Box = Merah | Update tiap frame"
espColorInfo.TextColor3 = Color3.fromRGB(180, 180, 180)
espColorInfo.Font = Enum.Font.Gotham
espColorInfo.TextSize = 11
espColorInfo.TextXAlignment = Enum.TextXAlignment.Left
espColorInfo.Parent = content
...
local function toggleMinimize()
    ...
    if isMinimized then
        ...
        mainFrame:TweenSize(UDim2.new(0, 350, 0, 700), "Out", "Quad", 0.2, true)
        task.wait(0.2)
...
local function createESP(player)
    ...
    espCache[player] = {boxOutline}

    RunService.RenderStepped:Connect(function()
        if espEnabled and player.Character
            ...
            if hrpVis and headVis then
                ...
                boxOutline.Position = Vector2.new(hrpPos.X - width / 2, headPos.Y - boxPadding)
