...
local function aimFreeAim(part, plr)
    ...
    -- Crosshair Roblox selalu di tengah viewport (bukan posisi mouse)
...
RunService.RenderStepped:Connect(function()
    -- Crosshair Roblox SELALU di tengah viewport, bukan ikut posisi mouse
    -- Jadi FOV circle harus di-lock ke ViewportSize/2 agar tepat mengelilingi crosshair
    local cx = Camera.ViewportSize.X / 2
    local cy = Camera.ViewportSize.Y / 2
...
print("=== MAJESTY ONTOP v16.0 - VALARY THEME ===")
print("Fitur:")
print("- 📦 Inventory Tracker")
print("- ⚙️  Auto MS")
print("- 👁️  ESP + Whitelist terintegrasi + Distance")
print("- 🚀 Teleport")
print("- 🎯 AIMBOT: FOV center crosshair | FreeAim | Body Part | Priority")
print("=========================================")
