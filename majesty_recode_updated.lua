...
do
    ...
    local tpLocs = {
        ...
        {name="🛣️  GS Ujung",             color=Color3.fromRGB(80,80,80),   x=-464.5489501953125,  y=3.7371325492858887,  z=335.3158874511719},
        {name="🛣️  GS Mid",               color=Color3.fromRGB(80,80,80),   x=218.74879455566406,  y=3.729842185974121,   z=-161.87036132812},
    }
...
do
    ...
    makeLabel(infoCard,"✅ Tidak perlu mati  |  ℹ️ Bisa dipakai saat naik motor",10,0,430,22,9,Color3.fromRGB(0,220,100))
