...
do
    ...
    pageAimbot.CanvasSize = UDim2.new(0, 0, 0, y + 40)
end
...
RunService.RenderStepped:Connect(function()
    -- FOV circle harus selalu di tengah layar (posisi crosshair Roblox)
    -- karena crosshair Roblox SELALU di tengah viewport, bukan ikut mouse
    local centerX = Camera.ViewportSize.X / 2
    local centerY = Camera.ViewportSize.Y / 2
    aimbotFovCircle.Position = Vector2.new(centerX, centerY)
    aimbotFovCircle.Radius   = aimbotFOV
